...
public class EmpServiceImpl implements EmpService {
	...
	public void showDetail() {
		...
		dto = dao.findUser(temp);
		if (dto != null) {
			empMain.empDetail.hpTf.setText(dto.getEmpHp());
			empMain.empDetail.nameTf.setText(dto.getEmpName());
			empMain.empDetail.idTf.setText(dto.getEmpId());
			empMain.empDetail.wageTf.setText(dto.getHourPayRate() + "");
			empMain.empDetail.yy.setSelectedItem(dto.getYy());
			empMain.empDetail.mm.setSelectedItem(dto.getMm());
			empMain.empDetail.dd.setSelectedItem(dto.getDd());
