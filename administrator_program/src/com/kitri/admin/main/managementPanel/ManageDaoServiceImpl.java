...
public class ManageDaoServiceImpl extends Dao implements BSDaoService {
...
//	Vector<BSDto> dtos = new Vector<BSDto>();
	...
	public ManageDaoServiceImpl () {}

	public ManageDaoServiceImpl (BSMain bsListFrame) {
...
System.out.println("s나와?");
	...
	public ManageDaoServiceImpl getBSDao (String name) {
		ManageDaoServiceImpl dao=null;
