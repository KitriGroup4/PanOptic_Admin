...
public class StatDaoServiceImpl extends Dao implements BSDaoService {
...
//	Vector<BSDto> dtos = new Vector<BSDto>();
	...
	public StatDaoServiceImpl () {}

	public StatDaoServiceImpl (BSMain bsListFrame) {
...
System.out.println("s나와?");
	...
	public StatDaoServiceImpl getBSDao (String name) {
		StatDaoServiceImpl dao=null;
