package com.kitri.admin.main.customerPanel.UserInfoBlackListFrame;
...
public class UserInfoBlackListFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserInfoBlackListFrame frame = new UserInfoBlackListFrame();
