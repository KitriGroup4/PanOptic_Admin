...
public class CusDaoServiceImpl extends Dao implements CusDaoService {
...
//	Vector<BSDto> dtos = new Vector<BSDto>();
	...
	public CusDaoServiceImpl () {}

	public CusDaoServiceImpl (CusMain cusMain) {
...
//		return dtos;
	...
	public boolean update(CusDto dto) {
...
System.out.println("s나와?");
	...
	public CusDto getBSDao (String name) {
		CusDto dto=null;
		...
		try {
			...
			if (rs.next())
				dto = new CusDto (rs.getInt("num"), rs.getString("url"), rs.getString("name"));
