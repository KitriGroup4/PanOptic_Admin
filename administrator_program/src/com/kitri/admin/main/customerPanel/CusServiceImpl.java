...
public class CusServiceImpl implements CusService {
	...
	public void updateUserJTable() {
		...
		cusMain.cusList.userListJTable.removeAll();
		// conMain.blockedsite.jTable.remove
		cusMain.cusList.userListJTable.setModel(model);
		model.fireTableDataChanged();
	}

	@Override
	public void updateBlackUserJTable() {
		insertColumnNames();
		...
		// conMain.blockedsite.jTable = new JTable(model);
		cusMain.cusList.blackListJTable.removeAll();
		// conMain.blockedsite.jTable.remove
		cusMain.cusList.blackListJTable.setModel(model);
		model.fireTableDataChanged();
	}
